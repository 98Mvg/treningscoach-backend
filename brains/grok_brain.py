...
WRONG (chat mode):
"Great work! You're breathing hard, which shows you're pushing yourself. Keep maintaining this intensity."
...
Your response will be spoken aloud to someone mid-workout. Make it count."""
        ...
        # Add style examples from config
        if phase == "intense" and intensitet in config.CONTINUOUS_COACH_MESSAGES.get("intense", {}):
    ...
    def _build_coaching_system_prompt(self, phase: str, intensitet: str) -> str:
        """Build system prompt for Grok coaching chat mode."""
...
"""
        ...
        # Add example messages from config
