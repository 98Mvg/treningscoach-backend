    ...
    var body: some View {
        Button(action: action) {
            ZStack {
                // Outer glow ring 2
                Circle()
                    .fill(CoachiTheme.primary.opacity(0.06))
                ...
                Circle()
                    ...
                    .shadow(color: CoachiTheme.primary.opacity(0.4), radius: 20, y: 5)
        ...
        .onAppear {
            withAnimation(
                .easeInOut(duration: AppConfig.Anim.orbIdlePulse)
