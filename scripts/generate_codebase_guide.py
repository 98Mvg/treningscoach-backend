...
PHASE_STATUS = [
    (
        ...
        "V2 NO/EN voice workflow, launch-safe settings/legal/support, mandatory Apple/email onboarding, watch icon/dashboard polish, and summary live-voice CTA parity are implemented.",
