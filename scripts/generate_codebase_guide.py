...
FEATURES = [
    ...
    (
        "Auth + Profile",
        "Apple sign-in, passwordless email sign-in, token lifecycle, refresh rotation, logout, and profile sync.",
        [
            "auth.py",
            "auth_routes.py",
            "TreningsCoach/TreningsCoach/Services/AuthManager.swift",
...
RECENT_SESSION_LEARNINGS = [
    (
        "2026-03-18 - Onboarding, Live Voice, Paywall, And Profile Reliability",
        "docs/plans/2026-03-18-session-learnings-onboarding-live-voice-paywall-profile-reliability.md",
        [
    ...
    (
        "2026-03-18 - Post-Workout Share, Live Voice, And Watch Runtime",
        "docs/plans/2026-03-18-session-learnings-post-workout-share-live-voice-and-watch-runtime.md",
        [
    ...
    (
        ...
        "docs/plans/2026-03-14-session-learnings-onboarding-controls-share-surfaces-and-free-live-voice.md",
        [
    ...
    (
        ...
        "docs/plans/2026-03-13-session-learnings-app-store-connect-pack-and-billing-smoke-matrix.md",
        [
    ...
    (
        "2026-03-11 — Onboarding Refresh And Welcome Retirement",
        "docs/plans/2026-03-11-session-learnings-onboarding-refresh-and-welcome-retirement.md",
        [
    ...
    (
        "2026-03-11 — Onboarding Auth And Live Voice Runtime Hardening",
        "docs/plans/2026-03-11-session-learnings-onboarding-auth-and-live-voice-hardening.md",
        [
...
PHASE_STATUS = [
    (
        ...
        "V2 NO/EN voice workflow, launch-safe settings/legal/support, free-core onboarding, watch icon/dashboard polish, and summary live-voice CTA parity are implemented.",
        "Finish deployed phrase-rotation, coach-score, no-HR audits, and final onboarding keyboard/device polish on real devices / live backend.",
    ),
    (
        "Phase 2",
    ...
    (
        ...
        "Grok-first workout talk and xAI live voice now sit on constrained language surfaces, while continuous coaching remains deterministic-first and live voice is history-aware plus timeout-hardened.",
        "Validate deployed xAI live voice rollout, free/premium limits, startup/close behavior, and confirm the new history-aware memory policy on real accounts.",
    ),
]
...
def _route_group(route: str) -> str:
    if route.startswith("/auth/"):
        return "Auth"
    if route.startswith("/coach/") or route in {"/workouts", "/profile/upsert", "/analyze"} or route.startswith("/download/"):
