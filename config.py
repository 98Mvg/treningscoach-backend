...
XAI_VOICE_AGENT_FREE_MAX_SESSION_SECONDS = _env_int("XAI_VOICE_AGENT_FREE_MAX_SESSION_SECONDS", 60)
XAI_VOICE_AGENT_PREMIUM_MAX_SESSION_SECONDS = _env_int("XAI_VOICE_AGENT_PREMIUM_MAX_SESSION_SECONDS", 180)
XAI_VOICE_AGENT_FREE_SESSIONS_PER_DAY = _env_int("XAI_VOICE_AGENT_FREE_SESSIONS_PER_DAY", 1)
