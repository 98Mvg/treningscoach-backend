...
SUPABASE_AUTH_REDIRECT_URL = (os.getenv("SUPABASE_AUTH_REDIRECT_URL", "") or "").strip()
SUPABASE_AUTH_ENABLED = bool(SUPABASE_URL and (SUPABASE_ANON_KEY or SUPABASE_PUBLISHABLE_KEY))
...
XAI_VOICE_AGENT_FREE_MAX_SESSION_SECONDS = _env_int("XAI_VOICE_AGENT_FREE_MAX_SESSION_SECONDS", 30)
XAI_VOICE_AGENT_PREMIUM_MAX_SESSION_SECONDS = _env_int("XAI_VOICE_AGENT_PREMIUM_MAX_SESSION_SECONDS", 180)
XAI_VOICE_AGENT_FREE_SESSIONS_PER_DAY = _env_int("XAI_VOICE_AGENT_FREE_SESSIONS_PER_DAY", 2)
XAI_VOICE_AGENT_PREMIUM_SESSIONS_PER_DAY = _env_int("XAI_VOICE_AGENT_PREMIUM_SESSIONS_PER_DAY", 3)
...
GOOGLE_AUTH_ENABLED = _env_bool("GOOGLE_AUTH_ENABLED", True)
...
GOOGLE_CLIENT_IDS = _env_csv_set(
    "GOOGLE_CLIENT_IDS",
    _env_csv_set("GOOGLE_CLIENT_ID", []),
)
...
BACKEND_STARTUP_MEMORY_LOGGING_ENABLED = _env_bool("BACKEND_STARTUP_MEMORY_LOGGING_ENABLED", True)
LIBROSA_STARTUP_PREWARM_ENABLED = _env_bool("LIBROSA_STARTUP_PREWARM_ENABLED", False)
