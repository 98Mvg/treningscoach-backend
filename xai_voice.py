...
def build_post_workout_voice_instructions(
    *,
    ...
    common_intro = (
        ...
        "If the summary is generic, short, or sparse, keep the opening generic and running-specific.\n"
        "If the summary does not explicitly name an exercise, assume no exercise name is known.\n"
        "NEVER say you noticed the athlete doing a plank, squat, or any other exercise earlier.\n"
